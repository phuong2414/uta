...
module.exports = createComponent({
	...
	localizationTemplate: resolve('i18n/{lang}.json')
			...
			var settings = require('settings'),
			  ...
			  return componentsDirecotry.replace(new RegExp('/$'), emptyString) + '/co-table/' + relativePath.replace(new RegExp('^/'), emptyString);
		})
},{"./src/js/table":18,"co-iscroll":2,"co-text":5,"component":9,"rivets":"rivets","settings":"settings"}],2:[function(require,module,exports){
(function (resolve){
'use strict';
...
module.exports = createComponent({
	...
	localizationTemplate: resolve('i18n/{lang}.json')
			...
			var settings = require('settings'),
			  ...
			  return componentsDirecotry.replace(new RegExp('/$'), emptyString) + '/co-table/_assets/co-iscroll/' + relativePath.replace(new RegExp('^/'), emptyString);
		})
},{"./src/js/iscroller.js":3,"component":9,"settings":"settings"}],3:[function(require,module,exports){
'use strict';
...
var Iscroller = exports.Iscroller = function (_Component) {
  ...
  function Iscroller(element) {
    ...
    _this.refresh('stopPropagationSwipe');
...
},{"../template.html":4,"component":9,"dispatcher":"dispatcher","iscroll":15,"touch":"touch"}],4:[function(require,module,exports){
module.exports = '<div class="scroller" rv-on-activate="activateElement" rv-on-deactivate="deactivateElement" co-iscroll><content co-iscroll></content></div>'
...
module.exports = createComponent({
	...
	localizationTemplate: resolve('i18n/{lang}.json')
			...
			var settings = require('settings'),
			  ...
			  return componentsDirecotry.replace(new RegExp('/$'), emptyString) + '/co-table/_assets/co-text/' + relativePath.replace(new RegExp('^/'), emptyString);
		})
},{"./src/js/text.js":6,"component":9,"settings":"settings"}],6:[function(require,module,exports){
'use strict';
...
},{"../template.html":7,"textable-component":16}],7:[function(require,module,exports){
...
},{"./config.json":8,"./src/js/ComponentConstructor.js":10,"./src/js/buildModel.js":13,"./src/js/buildObservations.js":14,"rivets":"rivets","utils":"utils"}],10:[function(require,module,exports){
'use strict';
...
},{"./buildKeypath.js":11,"./buildLocalization.js":12,"dispatcher":"dispatcher","es6-promise":"es6-promise","general-model":"general-model","utils":"utils"}],11:[function(require,module,exports){
'use strict';
...
},{"cache":"cache","es6-promise":"es6-promise","loader":"loader","utils":"utils"}],13:[function(require,module,exports){
"use strict";
...
},{"general-model":"general-model"}],15:[function(require,module,exports){
'use strict';
...
},{"./src/js/TextableComponent.js":17}],17:[function(require,module,exports){
'use strict';
...
},{"component":9,"rivets":"rivets","sightglass":"sightglass","translate":"translate","utils":"utils"}],18:[function(require,module,exports){
'use strict';
...
_rivets2.default.binders['border-w'] = {
	routine: function routine(element, width) {
		element.style.borderWidth = width + 'px' || '1px';
	}
};
_rivets2.default.binders['border-c'] = {
	routine: function routine(element, color) {
		element.style.borderColor = color || 'inherit';
	}
};
_rivets2.default.binders.bgc = {
	routine: function routine(element, bgsetting) {
...
_rivets2.default.binders.bgi = {
	routine: function routine(element, bgsetting) {
		if (!bgsetting && bgsetting !== '') {
			return;
		}
		element.style.backgroundImage = 'url(' + _utils2.default.formatSrc(bgsetting) + ')';
	}
};
_rivets2.default.binders.bgs = {
	routine: function routine(element, bgsetting) {
		if (!bgsetting && bgsetting !== '') {
			return;
		}
...
_rivets2.default.binders.colw = {
	routine: function routine(element, colWidth) {
		element.style.width = colWidth ? colWidth + 'px' : '';
	}
};

_rivets2.default.binders.rowh = {
	routine: function routine(element, rowHeight) {
...
var Table = exports.Table = function (_Component) {
	...
	_createClass(Table, [{
		key: 'checkborder',
		value: function checkborder(rows) {
			var _this2 = this;

			var table = this.element.querySelector('tbody');
			rows.forEach(function (rows, rowInd) {
				var count = 0,
				    tr = table.children[rowInd];
				rows.forEach(function (cell, celInd) {
					if (cell === 2) {
						count++;
					} else if (cell === 1) {
						var borderClass = '',
						    colspan = _this2.rows[rowInd].cells[celInd - count].colspan - 1;

						if (rows[celInd + colspan + 1] === 2 || rows[celInd - 1] === 2) {
							if (isFirstCell(celInd, count)) {
								borderClass += ' border-left';
							}
							if (isLastCell(celInd, count, _this2.rows[rowInd].cells, rows)) {
								borderClass += ' border-right';
							}
						}

						if (_this2.rows[rowInd].cells[celInd - count].rowspan > 1 && _this2.rows[rowInd].cells[celInd - count].rowspan + rowInd === _this2.rows.length) {
		...
		value: function createMatrix() {
			...
			this.rows.forEach(function (row, rowIndex) {
				...
				row.cells.forEach(function (cell) {
					colInd = _this3.getNextFreeCellColInd(matrix, rowIndex, colInd);
					matrix[rowIndex][colInd] = 1;
					if (cell.colspan > 1 || cell.rowspan > 1) {
						_this3.createAdditionCells(matrix, cell, rowIndex, colInd);
					}
				});
			});
			return matrix;
		...
		key: 'createAdditionCells',
		value: function createAdditionCells(matrix, cell, rowIndex, colInd) {
		...
		key: 'getNextFreeCellColInd',
		value: function getNextFreeCellColInd(matrix, currentRowInd, currentColInd) {
		...
		value: function update() {
			...
			setTimeout(function () {
				_this4.checkborder(_this4.createMatrix());
				_this4.coIscroll.scroller.refresh();
			});
		}
	}, {
		key: 'template',
...
},{"../template.html":20,"./utils.js":19,"component":9,"rivets":"rivets"}],19:[function(require,module,exports){
'use strict';
...
function formatSrc(src) {
	return (/\/common\//.test(src) ? _settings2.default.media + src : src
	);
}

...
module.exports = createComponent({
	...
	localizationTemplate: resolve('i18n/{lang}.json')
			...
			var settings = require('settings'),
			  ...
			  return componentsDirecotry + '/co-option/' + relativePath;
		})
},{"./src/js/Option.js":10,"component":4,"rivets":"rivets","settings":"settings"}],2:[function(require,module,exports){
"use strict";
...
},{"../template.html":11,"component":4,"utils":"utils"}],11:[function(require,module,exports){
module.exports = '<!-- TODO: remove first line and file src/css/option.css after fixing https://pm.mps-cg.com/browse/COBALTIO-5149 --><content co-option=""></content>'
},{}]},{},[1]);

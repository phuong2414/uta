...
require("rivets").components[module.exports.name] = module.exports;
			...
			var settings = require('settings'),
			  ...
			  return componentsDirecotry.replace(new RegExp('/$'), emptyString) + '/co-shower/' + relativePath.replace(new RegExp('^/'), emptyString);
		})
},{"./src/js/shower":11,"animate-binder":"animate-binder","component":4,"rivets":"rivets","settings":"settings"}],2:[function(require,module,exports){
"use strict";
...
},{"../template.html":12,"./event-manager":10,"animate-binder":"animate-binder","component":4,"dispatcher":"dispatcher","nav":"nav","prefixer":"prefixer","utils":"utils"}],12:[function(require,module,exports){

...
module.exports = createComponent({
	...
	localizationTemplate: resolve('i18n/{lang}.json')
			...
			var settings = require('settings'),
			  ...
			  return componentsDirecotry.replace(new RegExp('/$'), emptyString) + '/co-image/' + relativePath.replace(new RegExp('^/'), emptyString);
		})
},{"./src/js/image":10,"component":4,"rivets":"rivets","settings":"settings"}],2:[function(require,module,exports){
"use strict";
...
exports.default = Image;
			...
			var settings = require('settings'),
			  ...
			  return componentsDirecotry.replace(new RegExp('/$'), emptyString) + '/co-image/src/js/' + relativePath.replace(new RegExp('^/'), emptyString);
		})
},{"../template.html":11,"component":4,"settings":"settings"}],11:[function(require,module,exports){

...
var createComponent = require('component').createComponent,
    TextButton = require('./src/js/text-button').TextButton;
...
require("rivets").components[module.exports.name] = module.exports;
			...
			var settings = require('settings'),
			  ...
			  return componentsDirecotry.replace(new RegExp('/$'), emptyString) + '/co-text-button/' + relativePath.replace(new RegExp('^/'), emptyString);
		})
},{"./src/js/text-button":18,"co-button":3,"co-text":6,"component":10,"rivets":"rivets","settings":"settings"}],2:[function(require,module,exports){
"use strict";
...
module.exports = createComponent({
	...
	localizationTemplate: resolve('i18n/{lang}.json')
			...
			var settings = require('settings'),
			  ...
			  return componentsDirecotry.replace(new RegExp('/$'), emptyString) + '/co-text-button/_assets/co-button/' + relativePath.replace(new RegExp('^/'), emptyString);
		})
},{"./src/js/Button.js":4,"component":10,"settings":"settings"}],4:[function(require,module,exports){
'use strict';
...
},{"../template.html":5,"component":10,"nav":"nav","touch":"touch","utils":"utils"}],5:[function(require,module,exports){
...
module.exports = createComponent({
	...
	localizationTemplate: resolve('i18n/{lang}.json')
			...
			var settings = require('settings'),
			  ...
			  return componentsDirecotry.replace(new RegExp('/$'), emptyString) + '/co-text-button/_assets/co-text/' + relativePath.replace(new RegExp('^/'), emptyString);
		})
},{"./src/js/text.js":7,"component":10,"settings":"settings"}],7:[function(require,module,exports){
'use strict';
...
},{"../template.html":8,"textable-component":16}],8:[function(require,module,exports){
...
},{"component":10,"rivets":"rivets","sightglass":"sightglass","translate":"translate","utils":"utils"}],18:[function(require,module,exports){
'use strict';
...
var _coText = require('co-text');

var _coText2 = _interopRequireDefault(_coText);
...
var TextButton = exports.TextButton = function (_Component) {
		...
		get: function get() {
			return {
				...
				text: {
					...
					base: _coText2.default.constructor,
					scheme: _coText2.default.constructor.prototype.defaults,
					sealed: true
				}
			};
		}
...
},{"../template.html":19,"co-text":6,"component":10}],19:[function(require,module,exports){
module.exports = '<co-button class="default" toggles="toggles" active="active" pressed="pressed" shadow="shadow" disabled="disabled" sealed co-text-button><co-text model="text" fixed co-text-button></co-text></co-button>'
},{}]},{},[1]);

...
require("rivets").components[module.exports.name] = module.exports;
			...
			var settings = require('settings'),
			  ...
			  return componentsDirecotry.replace(new RegExp('/$'), emptyString) + '/co-iscroll/' + relativePath.replace(new RegExp('^/'), emptyString);
		})
},{"./src/js/iscroller.js":16,"co-container":3,"component":8,"rivets":"rivets","settings":"settings"}],2:[function(require,module,exports){
"use strict";
...
module.exports = createComponent({
	...
	localizationTemplate: resolve('i18n/{lang}.json')
			...
			var settings = require('settings'),
			  ...
			  return componentsDirecotry.replace(new RegExp('/$'), emptyString) + '/co-iscroll/_assets/co-container/' + relativePath.replace(new RegExp('^/'), emptyString);
		})
},{"./src/js/Container.js":4,"component":8,"settings":"settings"}],4:[function(require,module,exports){
"use strict";
...
},{"../template.html":6,"./utils.js":5,"component":8,"dispatcher":"dispatcher"}],5:[function(require,module,exports){
'use strict';
...
},{"./config.json":7,"./src/js/ComponentConstructor.js":9,"./src/js/buildModel.js":12,"./src/js/buildObservations.js":13,"rivets":"rivets","utils":"utils"}],9:[function(require,module,exports){
'use strict';
...
},{"./buildKeypath.js":10,"./buildLocalization.js":11,"dispatcher":"dispatcher","es6-promise":"es6-promise","general-model":"general-model","utils":"utils"}],10:[function(require,module,exports){
'use strict';
...
},{"cache":2,"es6-promise":"es6-promise","loader":"loader","utils":"utils"}],12:[function(require,module,exports){
"use strict";
...
},{"utils":"utils"}],13:[function(require,module,exports){
'use strict';
...
},{"general-model":"general-model"}],14:[function(require,module,exports){
'use strict';
...
var Iscroller = exports.Iscroller = function (_Component) {
	...
	_createClass(Iscroller, [{
		...
		value: function ready() {
			...
			_nav2.default.onready(function () {
				_this3.init();
			});
		}
	}, {
		...
		key: "setWrapperScrollTop",
		value: function setWrapperScrollTop() {
			var wrapper = this.scroller.wrapper;
...
},{"../template.html":17,"./StateIterator":15,"component":8,"dispatcher":"dispatcher","iscroll/build/iscroll-probe":14,"nav":"nav","touch":"touch","utils":"utils"}],17:[function(require,module,exports){

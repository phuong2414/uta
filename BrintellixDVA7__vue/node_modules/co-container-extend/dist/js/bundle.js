...
var createComponent = require('component').createComponent,
    ExtendContainer = require('./src/js/extend-container.js').ExtendContainer,
    rivets = require('rivets');

module.exports = createComponent({
	name: 'co-container-extend',
	constructor: ExtendContainer,
	localizationTemplate: resolve('i18n/{lang}.json')
			...
			var settings = require('settings'),
			  ...
			  return componentsDirecotry + '/co-container-extend/' + relativePath;
		})
},{"./src/js/extend-container.js":10,"component":4,"rivets":"rivets","settings":"settings"}],2:[function(require,module,exports){
"use strict";
...
exports.ExtendContainer = undefined;
...
var ExtendContainer = exports.ExtendContainer = function (_Component) {
	_inherits(ExtendContainer, _Component);

	function ExtendContainer() {
		_classCallCheck(this, ExtendContainer);

		var _this = _possibleConstructorReturn(this, (ExtendContainer.__proto__ || Object.getPrototypeOf(ExtendContainer)).apply(this, arguments));

		_this.init();
		return _this;
	}

	_createClass(ExtendContainer, [{
		key: 'init',
		value: function init() {
			this.toogleHide(this.hide);
		}
	}, {
		key: 'toogleHide',
		value: function toogleHide(hide) {
			this.element.classList[hide ? 'add' : 'remove']('hide');
		}
	}, {
		key: 'refresh',

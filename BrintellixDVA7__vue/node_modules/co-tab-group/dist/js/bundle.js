...
require("rivets").components[module.exports.name] = module.exports;
			...
			var settings = require('settings'),
			  ...
			  return componentsDirecotry.replace(new RegExp('/$'), emptyString) + '/co-tab-group/' + relativePath.replace(new RegExp('^/'), emptyString);
		})
},{"./src/js/Tab-group.js":31,"co-container":3,"co-menu":7,"component":24,"rivets":"rivets","settings":"settings"}],2:[function(require,module,exports){
"use strict";
...
module.exports = createComponent({
	...
	localizationTemplate: resolve('i18n/{lang}.json')
			...
			var settings = require('settings'),
			  ...
			  return componentsDirecotry.replace(new RegExp('/$'), emptyString) + '/co-tab-group/_assets/co-container/' + relativePath.replace(new RegExp('^/'), emptyString);
		})
},{"./src/js/Container.js":4,"component":24,"settings":"settings"}],4:[function(require,module,exports){
"use strict";
...
},{"../template.html":6,"./utils.js":5,"component":24,"dispatcher":"dispatcher"}],5:[function(require,module,exports){
'use strict';
...
},{"utils":"utils"}],6:[function(require,module,exports){
...
module.exports = createComponent({
	...
	localizationTemplate: resolve('i18n/{lang}.json')
			...
			var settings = require('settings'),
			  ...
			  return componentsDirecotry.replace(new RegExp('/$'), emptyString) + '/co-tab-group/_assets/co-menu/' + relativePath.replace(new RegExp('^/'), emptyString);
		})
},{"./src/js/menu.js":21,"co-iscroll":11,"co-select":15,"component":24,"settings":"settings"}],8:[function(require,module,exports){
(function (resolve){
'use strict';
...
module.exports = createComponent({
	...
	localizationTemplate: resolve('i18n/{lang}.json')
			...
			var settings = require('settings'),
			  ...
			  return componentsDirecotry.replace(new RegExp('/$'), emptyString) + '/co-tab-group/_assets/co-menu/_assets/co-container/' + relativePath.replace(new RegExp('^/'), emptyString);
		})
},{"./src/js/Container.js":9,"component":24,"settings":"settings"}],9:[function(require,module,exports){
'use strict';
...
},{"../template.html":10,"component":24}],10:[function(require,module,exports){
...
module.exports = createComponent({
	...
	localizationTemplate: resolve('i18n/{lang}.json')
			...
			var settings = require('settings'),
			  ...
			  return componentsDirecotry.replace(new RegExp('/$'), emptyString) + '/co-tab-group/_assets/co-menu/_assets/co-iscroll/' + relativePath.replace(new RegExp('^/'), emptyString);
		})
},{"./src/js/iscroller.js":13,"co-container":8,"component":24,"settings":"settings"}],12:[function(require,module,exports){
"use strict";
...
},{"../template.html":14,"./StateIterator":12,"component":24,"dispatcher":"dispatcher","iscroll/build/iscroll-probe":30,"touch":"touch","utils":"utils"}],14:[function(require,module,exports){
...
module.exports.multiple = multiple;
			...
			var settings = require('settings'),
			  ...
			  return componentsDirecotry.replace(new RegExp('/$'), emptyString) + '/co-tab-group/_assets/co-menu/_assets/co-select/' + relativePath.replace(new RegExp('^/'), emptyString);
		})
},{"./src/js/Select.js":16,"component":24,"settings":"settings"}],16:[function(require,module,exports){
'use strict';
...
},{"../template.html":20,"./multiple.js":17,"./single.js":18,"./utils.js":19,"component":24,"utils":"utils"}],17:[function(require,module,exports){
'use strict';
...
},{"./utils.js":19,"utils":"utils"}],19:[function(require,module,exports){
'use strict';
...
},{"utils":"utils"}],20:[function(require,module,exports){
...
},{"../template.html":22,"component":24,"utils":"utils"}],22:[function(require,module,exports){
...
},{"./config.json":23,"./src/js/ComponentConstructor.js":25,"./src/js/buildModel.js":28,"./src/js/buildObservations.js":29,"rivets":"rivets","utils":"utils"}],25:[function(require,module,exports){
'use strict';
...
},{"./buildKeypath.js":26,"./buildLocalization.js":27,"dispatcher":"dispatcher","es6-promise":"es6-promise","general-model":"general-model","utils":"utils"}],26:[function(require,module,exports){
'use strict';
...
},{"cache":2,"es6-promise":"es6-promise","loader":"loader","utils":"utils"}],28:[function(require,module,exports){
"use strict";
...
},{"utils":"utils"}],29:[function(require,module,exports){
'use strict';
...
},{"general-model":"general-model"}],30:[function(require,module,exports){
'use strict';
...
},{"../template.html":32,"component":24,"nav":"nav","touch":"touch","utils":"utils"}],32:[function(require,module,exports){

...
module.exports = createComponent({
	...
	localizationTemplate: resolve('i18n/{lang}.json')
			...
			var settings = require('settings'),
			  ...
			  return componentsDirecotry.replace(new RegExp('/$'), emptyString) + '/co-slider/' + relativePath.replace(new RegExp('^/'), emptyString);
		})
},{"./src/js/slider.js":13,"co-container":2,"component":7,"rivets":"rivets","settings":"settings"}],2:[function(require,module,exports){
(function (resolve){
'use strict';
...
module.exports = createComponent({
	...
	localizationTemplate: resolve('i18n/{lang}.json')
			...
			var settings = require('settings'),
			  ...
			  return componentsDirecotry.replace(new RegExp('/$'), emptyString) + '/co-slider/_assets/co-container/' + relativePath.replace(new RegExp('^/'), emptyString);
		})
},{"./src/js/Container.js":3,"component":7,"settings":"settings"}],3:[function(require,module,exports){
"use strict";
...
},{"../template.html":5,"./utils.js":4,"component":7,"dispatcher":"dispatcher"}],4:[function(require,module,exports){
'use strict';
...
},{"cache":"cache","es6-promise":"es6-promise","loader":"loader","utils":"utils"}],11:[function(require,module,exports){
"use strict";
...
},{"../template.html":14,"co-container":2,"component":7,"prefixer":"prefixer","rivets":"rivets","touch":"touch","utils":"utils"}],14:[function(require,module,exports){

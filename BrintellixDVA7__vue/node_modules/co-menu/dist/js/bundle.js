...
require("rivets").components[module.exports.name] = module.exports;
			...
			var settings = require('settings'),
			  ...
			  return componentsDirecotry + '/co-menu/' + relativePath;
		})
},{"./src/js/menu.js":24,"co-iscroll":6,"co-select":10,"component":17,"rivets":"rivets","settings":"settings"}],2:[function(require,module,exports){
"use strict";
...
module.exports = createComponent({
	...
	localizationTemplate: resolve('i18n/{lang}.json')
			...
			var settings = require('settings'),
			  ...
			  return componentsDirecotry + '/co-menu/_assets/co-container/' + relativePath;
		})
},{"./src/js/Container.js":4,"component":17,"settings":"settings"}],4:[function(require,module,exports){
'use strict';
...
},{"../template.html":5,"component":17}],5:[function(require,module,exports){
...
module.exports = createComponent({
	...
	localizationTemplate: resolve('i18n/{lang}.json')
			...
			var settings = require('settings'),
			  ...
			  return componentsDirecotry + '/co-menu/_assets/co-iscroll/' + relativePath;
		})
},{"./src/js/iscroller.js":8,"co-container":3,"component":17,"settings":"settings"}],7:[function(require,module,exports){
"use strict";
...
},{"es6-promise":"es6-promise"}],8:[function(require,module,exports){
"use strict";
...
var Iscroller = exports.Iscroller = function (_Component) {
	...
	_createClass(Iscroller, [{
		...
		value: function createScroller() {
			...
			var options = Object.assign({}, this, { scrollbars: false, probeType: 2 // disable default scrollbars
			});
		...
		value: function refreshScroll() {
			...
			setTimeout(function () {
				_this8.scroller.refresh();
				_this8.refresh('stopPropagationSwipe');
			});
		}
	}, {
		key: "scrollToElement",
		...
		value: function nextState() {
			...
			return this.stateIterator.next().then(function (state) {
				if (!state.done) {
					...
					_this9.currentPosition = state.value;
					_this9.scrollTo(x, y);
				}
				return state;
			});
...
},{"../template.html":9,"./StateIterator":7,"component":17,"dispatcher":"dispatcher","iscroll/build/iscroll-probe":23,"touch":"touch","utils":"utils"}],9:[function(require,module,exports){
...
module.exports.multiple = multiple;
			...
			var settings = require('settings'),
			  ...
			  return componentsDirecotry + '/co-menu/_assets/co-select/' + relativePath;
		})
},{"./src/js/Select.js":11,"component":17,"settings":"settings"}],11:[function(require,module,exports){
'use strict';
...
},{"../template.html":15,"./multiple.js":12,"./single.js":13,"./utils.js":14,"component":17,"utils":"utils"}],12:[function(require,module,exports){
'use strict';
...
},{"./utils.js":14,"utils":"utils"}],14:[function(require,module,exports){
'use strict';
...
},{"./config.json":16,"./src/js/ComponentConstructor.js":18,"./src/js/buildModel.js":21,"./src/js/buildObservations.js":22,"rivets":"rivets","utils":"utils"}],18:[function(require,module,exports){
'use strict';
...
},{"./buildKeypath.js":19,"./buildLocalization.js":20,"dispatcher":"dispatcher","es6-promise":"es6-promise","general-model":"general-model","utils":"utils"}],19:[function(require,module,exports){
'use strict';
...
},{"cache":2,"es6-promise":"es6-promise","loader":"loader","utils":"utils"}],21:[function(require,module,exports){
"use strict";
...
},{"utils":"utils"}],22:[function(require,module,exports){
'use strict';
...
},{"general-model":"general-model"}],23:[function(require,module,exports){
'use strict';
...
},{"../template.html":25,"component":17,"utils":"utils"}],25:[function(require,module,exports){
